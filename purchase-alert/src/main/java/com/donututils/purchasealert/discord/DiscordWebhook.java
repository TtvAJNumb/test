package com.donututils.purchasealert.discord;
...
/** Minimal, dependency-free Discord webhook client (same design as EconomyWatchdog's). */
public final class DiscordWebhook {
    ...
    private String buildPayload(String title, String description, int color, Map<String, String> fields) {
        ...
        return "{"
                + "\"username\":" + json(username == null ? "Store Purchases" : username) + ","
                + "\"embeds\":[{"
                + "\"title\":" + json(title) + ","
